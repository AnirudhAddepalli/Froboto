...
namespace SprayingSystem.ViewModels
{
    public class CameraViewModel : ViewModelBase
    {
        ...
        public CameraViewModel(UserOptions userOptions, Action<string> logger)
        {
        ...
        {
            Logger("Camera status: connecting");
